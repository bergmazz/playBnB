...
const SpotDetails = () => {
  ...
  let spotOwner = false;
  if (currentUser) {
    spotOwner = currentUser.id === spot.ownerId;
  }
          ...
          <div className="spot-detail-container">
            ...
            <div className="more-info">
              ...
              <div className="book-container">
                <div className="book-price">
                  <p className="big">${spot.price}</p>{" "}
                  <p className="smol"> night</p>
                </div>
                ...
                <button onClick={comingSoon} className="book-btn">
                  Book to stay and play
                </button>
              </div>
            </div>
            ...
            <div className="review-star">
              {isNaN(spot.avgRating) ? (
                ...
                <p>
                  <i className="fa-solid fa-star"></i>{" "}
                  {spot.avgRating.toFixed(1)} · {spot.Reviews.length}{" "}
                  {spot.Reviews.length === 1 ? "review" : "reviews"}
                </p>
              )}
            </div>
